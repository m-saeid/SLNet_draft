...
class Classification(nn.Module):
    def __init__(self,
                 ...
                 adaptive_ratio_1=[0.9, 0.9, 0.9, 0.9],
                 adaptive_res_dim_ratio_1=[0.25, 0.25, 0.25, 0.25],
                 agmentive_res_dim_ratio_1=[4, 4, 4, 4],

                 num_blocks2=[2, 2, 2, 2],
                 block2_mode=['mlp', 'mlp', 'mlp', 'mlp'],
                 adaptive_ratio_2=[0.9, 0.9, 0.9, 0.9],
                 adaptive_res_dim_ratio_2=[0.25, 0.25, 0.25, 0.25],
                 agmentive_res_dim_ratio_2=[4, 4, 4, 4],
        ...
        self.encoder = Encoder(
            ...
            adaptive_ratio_1=adaptive_ratio_1,
            adaptive_res_dim_ratio_1=adaptive_res_dim_ratio_1,
            agmentive_res_dim_ratio_1=agmentive_res_dim_ratio_1,

            num_blocks2=num_blocks2,
            block2_mode=block2_mode,
            adaptive_ratio_2=adaptive_ratio_2,
            adaptive_res_dim_ratio_2=adaptive_res_dim_ratio_2,
            agmentive_res_dim_ratio_2=agmentive_res_dim_ratio_2,
...
def parse_args():
    ...
    parser.add_argument('--transfer_mode', type=str, default='no-no-no-no', help='transfer_mode')
    parser.add_argument('--block1_mode', type=str, default='cross_residual-cross_residual-cross_residual-cross_residual', help='block1_mode')
    parser.add_argument('--adaptive_ratio_1', type=str, default='0.9-0.9-0.9-0.9', help='')
    parser.add_argument('--adaptive_res_dim_ratio_1', type=str, default='0.25-0.25-0.25-0.25', help='')
    parser.add_argument('--agmentive_res_dim_ratio_1', type=str, default='4-4-4-4', help='')

    parser.add_argument('--num_blocks2', type=str, default='1-1-2-1', help='num_blocks2')
    parser.add_argument('--block2_mode', type=str, default='cross_residual-cross_residual-cross_residual-cross_residual', help='block2_mode')
    parser.add_argument('--adaptive_ratio_2', type=str, default='0.9-0.9-0.9-0.9', help='')
    parser.add_argument('--adaptive_res_dim_ratio_2', type=str, default='0.25-0.25-0.25-0.25', help='')
    parser.add_argument('--agmentive_res_dim_ratio_2', type=str, default='4-4-4-4', help='')
...
def main():
    ...
    args.adaptive_ratio_1 = list(map(lambda x: float(x), args.adaptive_ratio_1.split('-')))
    args.adaptive_res_dim_ratio_1 = list(map(lambda x: float(x), args.adaptive_res_dim_ratio_1.split('-')))
    args.agmentive_res_dim_ratio_1 = list(map(lambda x: float(x), args.agmentive_res_dim_ratio_1.split('-')))
    ...
    args.adaptive_ratio_2 = list(map(lambda x: float(x), args.adaptive_ratio_2.split('-')))
    args.adaptive_res_dim_ratio_2 = list(map(lambda x: float(x), args.adaptive_res_dim_ratio_2.split('-')))
    args.agmentive_res_dim_ratio_2 = list(map(lambda x: float(x), args.agmentive_res_dim_ratio_2.split('-')))
    ...
    net = Classification(n=args.n,
                         ...
                         adaptive_ratio_1=args.adaptive_ratio_1,
                         adaptive_res_dim_ratio_1=args.adaptive_res_dim_ratio_1,
                         agmentive_res_dim_ratio_1=args.agmentive_res_dim_ratio_1,

                         num_blocks2=args.num_blocks2,
                         block2_mode=args.block2_mode,
                         adaptive_ratio_2=args.adaptive_ratio_2,
                         adaptive_res_dim_ratio_2=args.adaptive_res_dim_ratio_2,
                         agmentive_res_dim_ratio_2=args.agmentive_res_dim_ratio_2,
